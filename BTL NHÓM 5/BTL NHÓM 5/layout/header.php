...
<body>
  <header id='header'>
    ...
    <ul class="header-menu">
      ...
      <?php } else { ?>
      <li><a onclick="$('#user-setting').toggle()" id="s-s" data-stt='alreadysignin'>Chào <?php echo isset($_SESSION['user']['ten']) ? $_SESSION['user']['ten'] : ''; ?></a><div class='mn-ef'></div></li>
      <div id='user-setting'>
        <ul>
    ...
    <div class="header-detail">
      <p>68 Triều Khúc ,Thanh Trì ,Hà Nội <br>
